...
function Spinwheel(options){
    var defaults = {
        ...
        stages: 1, //segments to land on (in order) ["ringIndex, segmentIndex"]
        winAngle: 45, //at what angle the 'winning' segment should land (0 - 360)
    ...
    $$.prepareNextSpin = function(){
        ...
        if($$.o.currentStage + 1 < $$.o.stages.length){
            ...
            $$.o.state = 'stopped';
            document.getElementById("funfare").play();
            startTimer();
            //alert("HI");
        }
    };
    ...
    function step(timestamp, restart) {
        ...
        if($$.o.state == 'spinning' && timestamp - $$.o.spinStart > $$.o.spinTime){
            ...
            var endAngle = 360 - ($$.o.segmentAngle * _seg_index[1]) - offset + 225;
            
            endAngle = endAngle % 360;
            if(endAngle < 0) endAngle += 360;
            console.log("C:"+_currentAngle+" O:"+offset+" E:"+endAngle+" T:"+(endAngle+_currentAngle)+" W:"+($$.o.winAngle));
